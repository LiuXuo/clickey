...
; ========================== 说明 ==========================
; 1) 2 层结构：
;    第 1 层：双键（行键 30 + 列键 10 组合，30x10）
;    第 2 层：单键（3 行 x 10 列）
; 2) 行键：qwertyuiopasdfghjkl;zxcvbnm,./
;    列键：asdfghjkl;
...
Clickey_Init() {
    ...
    colKeys := ["a","s","d","f","g","h","j","k","l",";"]

    singleRows := []
    singleRows.Push(["q","w","e","r","t","y","u","i","o","p"])
    singleRows.Push(["a","s","d","f","g","h","j","k","l",";"])
    singleRows.Push(["z","x","c","v","b","n","m",",",".","/"])
